...
%%% = cmaes.m
%%% = Alex Turner
%%% = Downloaded on: 04/22/2016
%%% =----------------------------------------------------------------------
%%% = NOTES
%%% =  ( 1): Covariance Matrix Adaptation Evolution Strategy (CMA-ES).
%%% =  ( 2): From: "https://www.lri.fr/~hansen/cmaes_inmatlab.html".
%%% =  ( 3): Author: Nikolaus Hansen (Nikolaus.Hansen@Inria.fr).
%%% =  ( 4): See Hansen (2006) and references therein (also at bottom).
%%% =======================================================================
